...
Functionaliteit: leveren van inOnderzoek bij raadplegen met periode
  ...
  Regel: als de datum aanvang van de volgende verblijfplaats in onderzoek is, dan wordt inOnderzoek datumTot en datumIngangOnderzoek ook geleverd
    ...
    Abstract Scenario: <omschrijving> van volgende verblijfplaats in buitenland is in onderzoek
      ...
      | 1999                              | 20240228                               | 6014                          | Die Erste Straße                 | Beverly Hills CA 90210           | <aanduiding onderzoek>          | 20240516                       |
      Als verblijfplaatshistorie wordt gezocht met de volgende parameters
      | naam                | waarde              |
      | type                | RaadpleegMetPeriode |
      | burgerservicenummer | 000000012           |
  ...
  Regel: wanneer een veld of groep in onderzoek staat die niet in verblijfplaatshistorie voorkomt, wordt geen inOnderzoek geleverd
