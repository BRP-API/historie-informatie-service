...
namespace HaalCentraal.Generated.InformatieService
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("verblijfplaatsen", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class VerblijfplaatsBuitenlandVoorkomen : AbstractVerblijfplaatsVoorkomen
    {
        ...
        public AdresseringBuitenland Adressering { get; set; }
    ...
    /// <br/>* **verblijftNietOpAdresVanaf** : geeft aan op welke datum is vastgesteld dat de persoon niet langer op dit adres of deze locatie woont.
    /// <br/>
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AdresVoorkomen : AbstractVerblijfplaatsVoorkomen
    {
        ...
        [Newtonsoft.Json.JsonProperty("verblijftNietOpAdresVanaf", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public AbstractDatum VerblijftNietOpAdresVanaf { get; set; }

        [Newtonsoft.Json.JsonProperty("inOnderzoek", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public AdresVoorkomenInOnderzoek InOnderzoek { get; set; }

        [Newtonsoft.Json.JsonProperty("adressering", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public AdresseringBinnenland Adressering { get; set; }
    ...
    /// <br/>* **gemeenteVanInschrijving** - wordt gevuld met waarden uit de landelijke tabel 'Gemeenten'.
    /// <br/>* **verblijftNietOpAdresVanaf** : geeft aan op welke datum is vastgesteld dat de persoon niet langer op dit adres of deze locatie verblijft.
    /// <br/>
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class AdresseringBuitenland
    {
        ...
        [Newtonsoft.Json.JsonProperty("inOnderzoek", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public AdresseringBuitenlandInOnderzoek InOnderzoek { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AdresseringBuitenlandInOnderzoek : InOnderzoek
    {
        [Newtonsoft.Json.JsonProperty("adresregel1", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class AdresseringBinnenland
    {
        ...
        [Newtonsoft.Json.JsonProperty("inOnderzoek", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public AdresseringBinnenlandInOnderzoek InOnderzoek { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.8.0 (NJsonSchema v11.0.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AdresseringBinnenlandInOnderzoek : InOnderzoek
    {
        [Newtonsoft.Json.JsonProperty("adresregel1", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? Adresregel1 { get; set; }
