...
namespace HaalCentraal.Generated.DataService
{
    ...
    public partial class GbaVerblijfplaatsVoorkomen : GbaVerblijfplaatsBeperkt
    {
        ...
        [Newtonsoft.Json.JsonProperty("datumAanvangVolgendeAdresBuitenland", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("datumAanvangVolgendeAdreshouding", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("inOnderzoekVolgendeVerblijfplaats", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class GbaInOnderzoek
    {
        ...
        [Newtonsoft.Json.JsonProperty("datumEindeOnderzoek", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
